                ...
                <div class="flex items-center justify-between h-16 md:h-20">
                    ...
                    <a href="/" class="flex items-center gap-2 flex-shrink-0">
                        ...
                        <div class="md:hidden w-10 h-10">
                            <img src="/images/logo.png" alt="TAO Logo" width="40" height="40" class="w-full h-full" />
                        </div>
                        <!-- Desktop Logo -->
                        <div class="hidden md:block h-16">
                            <img src="/images/logo-full.jpeg" alt="TAO Association of Nepal" height="64" width="300"
                                class="h-full w-auto" />
                        </div>
                    </a>
