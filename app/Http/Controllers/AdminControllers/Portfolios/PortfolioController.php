...
class PortfolioController extends Controller
{
    ...
    public function create()
    {
        ...
        $file1 = array('portfolio-default' => 'Choose Template');
        ...
        $ordering = $ord + 1;
        return view('admin.portfolio.create', compact('category', 'ordering','templates'));
    }
    ...
    public function edit(PortfolioModel $portfolioModel, $id)
    {
        ...
        return view('admin.portfolio.edit', compact('data', 'category','templates'));
    }
