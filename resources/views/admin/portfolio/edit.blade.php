...
@endsection
@section('content')
    <form class="form-horizontal" role="form" action="{{ route('our-trades.update', $data->id) }}" method="post"
        ...
        <div class="col-md-9">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <span class="panel-title">Edit Progrmas</span>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <div class="bs-component">
                                <textarea class="form-control my-editor" id="editor2" name="content" rows="30"> {{ $data->content }}</textarea>
                            </div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="inputStandard" class="col-lg-2 control-label">Requirements</label>
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <textarea class="form-control my-editor" id="" name="client_name" rows="10"> {{ $data->client_name }}</textarea>
                            </div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="inputStandard" class="col-lg-2 control-label">Included</label>
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <textarea class="form-control my-editor" id="" name="country" rows="20"> {{ $data->country }}</textarea>
                            </div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="inputStandard" class="col-lg-2 control-label">Not Included</label>
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <textarea class="form-control my-editor" id="" name="service" rows="20"> {{ $data->service }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="inputStandard" class="col-lg-2 control-label">Meta Keywords</label>
                        <div class="col-lg-9">
                            <div class="bs-component">
                    ...
                    <div class="form-group">
                        <label for="inputStandard" class="col-lg-2 control-label"> External Links</label>
                        <div class="col-lg-9">
                            <div class="bs-component">
