                                        ...
                                        <tr class="id{{$row->id}}">
                                            ...
                                            <td class="post_title title_hi_sh">
                                                ...
                                                <div class="row_actions"><span class="id">ID: {{$row->id}} | </span><span
                                                    ...
                                                    <span class="trash"><a href="#{{$row->id}}" class="submitdelete1">Delete</a>
                                                    </span>
                                            </td>
                                            <td>
                                                <strong> {{ get_program_category($row->category_id) }} </strong>
                                            </td>
                                            <td class="categories">
                                                {{ $row->ordering }}
                                            </td>
...
@section('libraries')
    ...
    <script
        src="{{asset(env('PUBLIC_PATH') . 'vendor/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.min.js')}}"></script>
    <!-- Datatables ColReorder addon -->
    <script
        src="{{asset(env('PUBLIC_PATH') . 'vendor/plugins/datatables/extensions/ColReorder/js/dataTables.colReorder.min.js')}}"></script>
