...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{ route('postcategory.update', $data->id) }}" method="post"
        ...
        <div class="col-md-8">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <span class="panel-title">Create Post Category aaa</span>
                </div>
                <div class="panel-body">
                            ...
                            <div class="bs-component">
                                <select class="form-control" name="post_type">
                                    @foreach ($posttype as $row)
                                        <option value="{{ $row->id }}"
                                            {{ $row->id == $data->post_type ? 'selected' : '' }}>{{ $row->post_type }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <input type="text" id="" name="category_caption" class="form-control"
                                    value="{{ $data->category_caption }}" placeholder="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <div class="bs-component">
                                    <div class="bs-component">
                                        <textarea class="form-control my-editor" id="textArea3" name="category_content" rows="3" autocomplete="off">{{ $data->category_content }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
