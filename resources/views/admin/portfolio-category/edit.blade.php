...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{ route('programcategory.update', $data->id) }}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <input type="text" id="category" name="category" class="form-control" value="{{$data->category}}" required/>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="bs-component">
                                    <div class="bs-component">
                                        <textarea class="form-control" id="" name="category_content" rows="3"
                                            autocomplete="off">{{$data->category_content}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="admin-form">
                ...
                <div class="sid_bvijay mb10">
                    <label class="field text">
                        <input type="number" id="" name="ordering" class="form-control" value="{{$data->ordering}}"
