                ...
                <div class="panel-body">
                    ...
                    @if (Request::segment(2) == 'locations')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="bs-component">
                                    <textarea type="text" class="form-control" id="" name="map_link" ></textarea>
                                </div>
                            </div>
                        </div>
                    @endif
                                        ...
                                        @foreach ($parent_post as $row)
                                            ...
                                            @if (has_child_post($row->id))
                                                @foreach (has_child_post($row->id) as $child_row)
                                                    <option value="{{ $child_row->id }}"> —> {{ $child_row->post_title }}
                                                    </option>
                ...
                <div class="sid_ mb10">
                    ...
                    <label class="field select">
                        <select id="template" name="price" style="font-family: 'FontAwesome';">
                            ...
                            <option value="person-walking-dashed-line-arrow-right">person-walking-dashed-line-arrow-right
                            </option>
                            ...
                            <option value="house-flood-water-circle-arrow-right">house-flood-water-circle-arrow-right
                            </option>
                            ...
                            <option value="american-sign-language-interpreting">american-sign-language-interpreting
                            </option>
                            <option value="asl-interpreting">asl-interpreting</option>
                            <option value="hands-american-sign-language-interpreting">
                                hands-american-sign-language-interpreting</option>
                            ...
                            <option value="sr-only-focusable:not(:focus) ">sr-only-focusable:not(:focus) </option> width:
                            1px;
                            height: 1px;
                            padding: 0;
                            margin: -1px;
