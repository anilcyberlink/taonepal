            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <input type="text" id="" name="location1" class="form-control" placeholder=""
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <input type="text" id="" name="phone2" class="form-control" placeholder=""
                                    value="{{$data->phone2}}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <textarea class="form-control" id="" name="google_map2"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <textarea class="form-control" id="" name="copyright_text"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="bs-component">
                                ...
                                <input type="text" id="" name="signin_url" class="form-control" placeholder=""
                                    value="{{$data->signin_url}}" />
                                <input type="text" id="" name="signup_url" class="form-control" placeholder=""
                                    value="{{$data->signup_url}}" />
                                <input type="text" class="form-control" id="" name="location_link"
