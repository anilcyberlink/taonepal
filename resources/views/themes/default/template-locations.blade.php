        ...
        <div class="grid md:grid-cols-3 gap-12">
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-lg border border-border bg-card p-6">
                    <h3 class="font-bold text-foreground mb-4 font-display">Contact Information</h3>
                    <div class="space-y-3">
                        <div class="space-y-4">
                            <div class="flex gap-3 items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted-foreground">{{ $data->address}}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-3 items-center">
                                ...
                                <div>
                                    ...
                                    <a class="text-primary hover:underline">{{ $data->phone }}</a>
                                </div>
                            </div>
