...
<section style="width:100%; height:500px;">
    {!! preg_replace(
        '/<iframe/i',
        '<iframe style="width:100% !important; height:100% !important; border:0;"',
        $setting->google_map2
    ) !!}
</section>
<!-- Main Content -->
        ...
        <div class="grid md:grid-cols-3 gap-12">
            ...
            <div class="md:col-span-2">
                <div class="rounded-lg border border-border bg-card p-8">
                    ...
                    <!-- Form -->
                    <form action="{{ route('sendmail_contact') }}" method="post" id="contact-form" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="text-sm font-medium text-foreground block mb-2">Contact</label>
                                <input type="text" name="phone" required placeholder="Phone Number" class="w-full px-4 py-2 border border-border rounded-lg bg-background text-foreground focus-2 focus:ring-primary" />
                            </div>
                        </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-muted-foreground">{{ $setting->location1 }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <a href="tel:{{ $setting->phone }}" class="text-sm text-primary hover:underline">{{ $setting->phone }}</a><br>
                                <a href="tel:{{ $setting->phone }}" class="text-sm text-primary hover:underline">{{ $setting->phone2 }}</a>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <a class="text-sm text-primary hover:underline">{{ $setting->email_primary }}</a><br>
                                <a class="text-sm text-primary hover:underline">{{ $setting->email_secondary }}</a>
                            </div>
                        </div>
